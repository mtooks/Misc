...
DYE_RULES = [
    ("Colored core", r"\bcore\b|gradient"),
    ...
    ("Fade-reveal", r"secret agent|fingerprint|\bfade\b|reveal"),
]
THEME_RULES = [
    ...
    ("Dragon Ball", r"goku|saiyan|trunks future|majin|vegeta|gohan"),
...
def tag_row(row):
    ...
    row["fiber"] = fibers(name)
    row["dye"] = dyes(name)
    row["theme"] = themes(name)
    return row
